...
namespace Mf\FeedYaNews\Reader\Feed;

use DOMDocument;
use DOMElement;
use DOMXPath;
use Mf\FeedYaNews\Reader;
use Mf\FeedYaNews\Reader\Exception;
...
abstract class AbstractFeed implements FeedInterface
{
     ...
     *
     * @return \Mf\FeedYaNews\Reader\Entry\EntryInterface
     */
     ...
     *
     * @param string $name
     * @return \Mf\FeedYaNews\Reader\Extension\AbstractFeed|null
     */
