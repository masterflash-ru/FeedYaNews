...
use Mf\FeedYaNews\Reader\Exception\InvalidHttpClientException;
...
class Reader implements ReaderImportInterface
{
    ...
    public static function importString($string)
    {
        ...
        if (0 === strpos($type, 'rss')) {
            ...
            . 'valid Atom, RSS or RDF feed that Mf\FeedYaNews\Reader can parse.');
        }
        return $reader;
    }
    ...
    public static function detectType($feed, $specOnly = false)
    {
        if ($feed instanceof Feed\AbstractFeed) {
            ...
            . ' be of type Mf\FeedYaNews\Reader\Feed, DomDocument or string');
        }
