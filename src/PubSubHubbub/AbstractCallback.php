...
{
    /**
     * An instance of Mf\FeedYaNews\Pubsubhubbub\Model\SubscriptionPersistenceInterface
     ...
     * Mf\FeedYaNews\Pubsubhubbub\HttpResponse which shares an unenforced interface with
    ...
    /**
     * Sets an instance of Mf\FeedYaNews\Pubsubhubbub\Model\SubscriptionPersistence used
    ...
    /**
     * Gets an instance of Mf\FeedYaNews\Pubsubhubbub\Model\SubscriptionPersistence used
     * to background save any verification tokens associated with a subscription
     * or other.
     *
    ...
    public function getStorage()
    {
        if ($this->storage === null) {
            throw new Exception\RuntimeException('No storage object has been'
                . ' set that subclasses Mf\FeedYaNews\Pubsubhubbub\Model\SubscriptionPersistence');
        }
        return $this->storage;
    }
    ...
    public function setHttpResponse($httpResponse)
    {
        if (! $httpResponse instanceof HttpResponse && ! $httpResponse instanceof PhpResponse) {
            throw new Exception\InvalidArgumentException('HTTP Response object must'
                . ' implement one of Mf\FeedYaNews\Pubsubhubbub\HttpResponse or'
