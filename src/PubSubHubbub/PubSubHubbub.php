...
class PubSubHubbub
{
     ...
     * best if directly given an instance of Mf\FeedYaNews\Reader\Atom|Rss
     * to leverage off.
     *
     * @param  \Mf\FeedYaNews\Reader\Feed\AbstractFeed|string $source
     * @return array
    ...
    public static function detectHubs($source)
    {
        if (is_string($source)) {
            ...
            . ' Mf\FeedYaNews\Reader\Feed\AbstractFeed');
        }
        return $feed->getHubs();
    }
