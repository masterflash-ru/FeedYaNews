...
namespace Mf\FeedYaNews\PubSubHubbub;
...
class Subscriber
{
     ...
     *
     * Mf\FeedYaNews\Pubsubhubbub\Subscriber will always send both modes, whose
    ...
    /**
     * An instance of Mf\FeedYaNews\Pubsubhubbub\Model\SubscriptionPersistence used to background
     * save any verification tokens associated with a subscription or other.
     *
     * @var \Mf\FeedYaNews\PubSubHubbub\Model\SubscriptionPersistenceInterface
     */
     ...
     * Mf\FeedYaNews\Pubsubhubbub\Subscriber\Callback::setSubscriptionKey(). Will
    ...
    public function setPreferredVerificationMode($mode)
    {
        if ($mode !== PubSubHubbub::VERIFICATION_MODE_SYNC
            ...
            throw new Exception\InvalidArgumentException('Invalid preferred'
                ...
                . ' Mf\FeedYaNews\Pubsubhubbub::VERIFICATION_MODE_SYNC or'
                . ' Mf\FeedYaNews\Pubsubhubbub::VERIFICATION_MODE_ASYNC');
        }
    ...
    /**
     * Sets an instance of Mf\FeedYaNews\Pubsubhubbub\Model\SubscriptionPersistence used to background
     * save any verification tokens associated with a subscription or other.
     *
    ...
    /**
     * Gets an instance of Mf\FeedYaNews\Pubsubhubbub\Storage\StoragePersistence used
