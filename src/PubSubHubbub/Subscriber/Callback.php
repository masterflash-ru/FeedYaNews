...
namespace Mf\FeedYaNews\PubSubHubbub\Subscriber;

use Mf\FeedYaNews\PubSubHubbub;
use Mf\FeedYaNews\PubSubHubbub\Exception;
...
class Callback extends PubSubHubbub\AbstractCallback
{
     ...
     *
     * @param  string $key
     * @return \Mf\FeedYaNews\PubSubHubbub\Subscriber\Callback
     */
